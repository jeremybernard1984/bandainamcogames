...
<form method="post" name="editForm" >
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="index.php?p=admin.pages.index">Genres list</a>
            </li>
            <li class="active">
                Genres edit
            </li>
